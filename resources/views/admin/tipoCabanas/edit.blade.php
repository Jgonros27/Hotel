...
@section('content_body')
    ...
    <form action="{{ route('tipoCabanas.update', $tipoCabana->id) }}" method="POST" class="w-75 mx-auto">
        @csrf
        @method('PATCH')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class="form-control" value="{{ $tipoCabana->nombre }}" id="nombre"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="precio" class="form-control" value="{{ $tipoCabana->precio }}" id="precio"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="capacidad" class="form-control" id="capacidad" value="{{ $tipoCabana->capacidad }}"
                ...
                <input type="hidden" id="serviciosHidden" name="servicios" value="{{ $tipoCabana->servicios }}">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="precio_media_pension" class="form-control" id="precio_media_pension"
                        placeholder="Introduce el precio de la media pension" value="{{ $tipoCabana->precio_media_pension }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="dias_cancelacion" class="form-control" id="dias_cancelacion"
                        placeholder="Introduce los días de cancelación" value="{{ $tipoCabana->dias_cancelacion }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="especificaciones" class="form-control" id="especificaciones" rows="5" 
                              placeholder="Introduce las especificaciones">{{ $tipoCabana->especificaciones }}</textarea>
