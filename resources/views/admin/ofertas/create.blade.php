...
<form action="{{ route('ofertas.store') }}" method="POST" class="w-50" enctype="multipart/form-data">
    @csrf
    @method('POST')
    ...
    <div class="form-group">
        ...
        <input type="text" name="descuento" class="form-control" value="{{ old('descuento') }}" id="descuento" placeholder="Introduce el descuento %">
        @error('descuento')
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                <div>{{ $message }}</div>
    ...
    <div class="form-group">
        ...
        <input type="date" name="fechaInicio" class="form-control" value="{{ old('fechaInicio') }}" id="fechaInicio">
        @error('fechaInicio')
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                <div>{{ $message }}</div>
    ...
    <div class="form-group">
        ...
        <input type="date" name="fechaFin" class="form-control" value="{{ old('fechaFin') }}" id="fechaFin">
        @error('fechaFin')
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                <div>{{ $message }}</div>
