...
class ImagenCabanaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'imagenCabana' => 'required', // El campo imagenCabana es obligatorio
    ...
    public function messages(): array
    {
        return [
            ...
            'imagenCabana.required' => 'Campo obligatorio.', // Mensaje de error para campo imagenCabana obligatorio
        ];
    }
}
